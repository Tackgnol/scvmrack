...
INSERT INTO public.equipment VALUES (31, 'equipment.red-poison', '{consumable,poison,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 20, false, NULL, 1, NULL, NULL, '{"type": "SingleUse"}');
INSERT INTO public.equipment VALUES (32, 'equipment.black-poison', '{consumable,poison,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 20, false, NULL, 1, NULL, NULL, '{"type": "SingleUse"}');
...
INSERT INTO public.equipment VALUES (54, 'equipment.ezumiel-vapor', '{consumable,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 0, false, NULL, 1, NULL, NULL, '{"type": "SingleUse", "effectDie": 4}');
INSERT INTO public.equipment VALUES (55, 'equipment.southern-frog', '{consumable,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 0, false, NULL, 1, NULL, NULL, '{"type": "SingleUse", "effectDie": 4}');
INSERT INTO public.equipment VALUES (56, 'equipment.elixir-vitalis', '{consumable,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 0, false, NULL, 1, NULL, NULL, '{"heal": 6, "type": "SingleUse"}');
INSERT INTO public.equipment VALUES (57, 'equipment.spider-owl-soup', '{consumable,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 0, false, NULL, 1, NULL, NULL, '{"type": "SingleUse"}');
INSERT INTO public.equipment VALUES (58, 'equipment.fernors-philtre', '{consumable,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 0, false, NULL, 1, NULL, NULL, '{"type": "SingleUse", "effectDie": 4}');
INSERT INTO public.equipment VALUES (59, 'equipment.hyphos-snuff', '{consumable,decoction,wywar,wywary}', NULL, NULL, NULL, NULL, NULL, NULL, 0, false, NULL, 1, NULL, NULL, '{"type": "SingleUse", "statuses": [{"value": -2, "source": "Hyphos snuff", "exclude": ["ability", "heal", "ranged", "melee", "cast"], "statistic": "agility"}]}');
...
INSERT INTO public.translations VALUES ('en', 'equipment.red-poison', 'Red Poison');
INSERT INTO public.translations VALUES ('en', 'equipment.red-poison.description', 'Toughness DR12 or -D10 HP.');
INSERT INTO public.translations VALUES ('en', 'equipment.black-poison', 'Black Poison');
INSERT INTO public.translations VALUES ('en', 'equipment.black-poison.description', 'Toughness DR14 or -D6 HP and blinded for one hour.');
...
INSERT INTO public.translations VALUES ('en', 'equipment.ezumiel-vapor', 'Ezumiel''s Vapor');
INSERT INTO public.translations VALUES ('en', 'equipment.ezumiel-vapor.description', 'Pass a DR14 test or severe (and arguably fun) hallucinations for D4 hours.');
INSERT INTO public.translations VALUES ('en', 'equipment.southern-frog', 'Southern Frog Stew');
INSERT INTO public.translations VALUES ('en', 'equipment.southern-frog.description', 'Vomit for D4 hours, pass a DR14 test or you can do nothing else.');
...
INSERT INTO public.translations VALUES ('en', 'equipment.fernors-philtre.description', 'Translucent oil, must be dabbed right into the eye. Heals infection and gives +2 on Presence tests for D4 hours.');
INSERT INTO public.translations VALUES ('en', 'equipment.hyphos-snuff', 'Hyphos'' Enervating Snuff');
INSERT INTO public.translations VALUES ('en', 'equipment.hyphos-snuff.description', 'Berserk! Two attacks per round but defend with DR14. Lasts one fight. Must be snorted, causes sneezing.');
...
INSERT INTO public.translations VALUES ('pl', 'equipment.red-poison', 'czerwona trucizna');
INSERT INTO public.translations VALUES ('pl', 'equipment.red-poison.description', 'Wytrzymałość ST12 lub -k10 PŻ.');
INSERT INTO public.translations VALUES ('pl', 'equipment.black-poison', 'Czarna Trucizna');
INSERT INTO public.translations VALUES ('pl', 'equipment.black-poison.description', 'Wytrzymałość ST14 lub -k6 PŻ i ślepota przez godzinę.');
...
INSERT INTO public.translations VALUES ('pl', 'equipment.ezumiel-vapor', 'Inhalacje Ezumielskie');
INSERT INTO public.translations VALUES ('pl', 'equipment.ezumiel-vapor.description', 'Zdaj test o ST14 lub doświadczasz poważnych (i nawet zabawnych) halucynacji przez k4 godziny.');
INSERT INTO public.translations VALUES ('pl', 'equipment.southern-frog', 'Potrawka z Żaby Południowej');
INSERT INTO public.translations VALUES ('pl', 'equipment.southern-frog.description', 'Rzygasz przez k4 godziny. Zdaj test o DR14 albo nie możesz robić nic innego.');
INSERT INTO public.translations VALUES ('pl', 'equipment.elixir-vitalis', 'Eliksir Vitalis');
INSERT INTO public.translations VALUES ('pl', 'equipment.elixir-vitalis.description', 'Leczy k6 PŻ i usuwa infekcję. Potencjalnie uzależniający.');
INSERT INTO public.translations VALUES ('pl', 'equipment.spider-owl-soup', 'Rosół z Sowopająka');
INSERT INTO public.translations VALUES ('pl', 'equipment.spider-owl-soup.description', 'Widzisz w ciemności i możesz łazić po ścianach przez pół godziny.');
INSERT INTO public.translations VALUES ('pl', 'equipment.fernors-philtre', 'Ekstrakt Fernora');
INSERT INTO public.translations VALUES ('pl', 'equipment.fernors-philtre.description', 'Bezbarwny olejek aplikowany bezpośrednio na oko. Leczy infekcję i dodaje +2 do rzutów na Opanowanie przez k4 godziny.');
INSERT INTO public.translations VALUES ('pl', 'equipment.hyphos-snuff', 'Ożywcza Tabaka Hyphosa');
INSERT INTO public.translations VALUES ('pl', 'equipment.hyphos-snuff.description', 'Furia! Dwa ataki na rundę, ale bronisz się na ST14. Trwa jedną walkę. Wciągana nosem, powoduje kichanie.');
...
INSERT INTO public.translations VALUES ('en', 'abilities.occult_herbmaster.ezumiel', 'Ezumiel''s Vapor: Pass a DR14 test or severe (and arguably fun) hallucinations for D4 hours.');
...
INSERT INTO public.translations VALUES ('en', 'abilities.occult_herbmaster.philtre', 'Fernor''s Philtre: Translucent oil, must be dabbed right into the eye. Heals infection and gives +2 on Presence tests for D4 hours.');
INSERT INTO public.translations VALUES ('en', 'abilities.occult_herbmaster.hyphos', 'Hyphos'' Enervating Snuff: Berserk! Two attacks per round but defend with DR14. Lasts one fight. Must be snorted, causes sneezing.');
...
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.decoctions', 'Przenośne laboratorium: Każdego dnia masz składniki, by przyrządzić dwa losowe wywary w łącznej liczbie k4 dawek. Nieużyte tracą skuteczność po dobie.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.red_poison', 'czerwona trucizna: Wytrzymałość ST12 lub -k10 PŻ.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.ezumiel', 'Inhalacje Ezumielskie: Zdaj test o ST14 lub doświadczasz poważnych (i nawet zabawnych) halucynacji przez k4 godziny.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.frog', 'Potrawka z Żaby Południowej: Rzygasz przez k4 godziny. Zdaj test o DR14 albo nie możesz robić nic innego.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.vitalis', 'Eliksir Życia: Leczy k6 PŻ i usuwa infekcję. Potencjalnie uzależniający.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.soup', 'Rosół z Sowopająka: Widzisz w ciemności i możesz łazić po ścianach przez pół godziny.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.philtre', 'Ekstrakt Fernora: Bezbarwny olejek aplikowany bezpośrednio na oko. Leczy infekcję i dodaje +2 do rzutów na Opanowanie przez k4 godziny.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.hyphos', 'Ożywcza Tabaka Hyphosa: Furia! Dwa ataki na rundę, ale bronisz się na ST14. Trwa jedną walkę. Wciągana nosem, powoduje kichanie.');
INSERT INTO public.translations VALUES ('pl', 'abilities.occult_herbmaster.black_poison', 'Czarna Trucizna: Wytrzymałość ST14 lub -k6 PŻ i ślepota przez godzinę.');
