...
Architecture review + UI mockups: `C:\Users\<user>\AppData\Local\Temp\architecture-review-owlbear-1719399600.html`
SDK reference: `docs/owlbear/` (saved API pages). Official tutorial clones are local-only and not committed.
Branch: `feat/owlbear`
