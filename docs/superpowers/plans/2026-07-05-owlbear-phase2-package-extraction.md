...
- **Repos:** `C:\Users\Adam\WebstormProjects\rpgtools-owlbear` (new repo, Tasks 1–11) and `C:\Users\Adam\WebstormProjects\scvmrack` (Tasks 12–14). Every step's paths are relative to the repo named in its task.
...
Expected: cloned empty repo at `C:\Users\Adam\WebstormProjects\rpgtools-owlbear`.
