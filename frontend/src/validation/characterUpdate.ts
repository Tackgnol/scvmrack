...
export const characterUpdateSchema = z.object({
  ...
  trait1: limitedString(255).optional(),
  trait2: limitedString(255).optional(),
  habit: limitedString(1000).optional(),
  tale: limitedString(1000).optional(),
  bodyDescription: limitedString(1000).optional(),
  origin: limitedString(1000).optional(),
