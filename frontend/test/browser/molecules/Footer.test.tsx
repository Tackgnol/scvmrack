...
describe('Footer Component', () => {
    ...
    it('renders default Generate New button and handles click', async () => {
        ...
        await expect.element(page.getByTestId('kill-scvm-button')).not.toBeInTheDocument();
    });
    ...
    it('opens privacy drawer when legal notice link is clicked', async () => {
        ...
        await expect.poll(() => privacyBus.requestOpenPrivacyDrawer).toHaveBeenCalledOnce();
    });
});
