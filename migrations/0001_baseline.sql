-- ==============================================================
-- 0001_baseline.sql
-- Auto-generated baseline from init/ on 2026-04-25.
-- This represents the full schema + seed data state at the point
-- migrations were introduced. Do NOT edit; create new migrations.
--
-- Top-level BEGIN;/COMMIT;/ROLLBACK; lines are stripped because
-- the runner wraps each migration in its own transaction.
-- pg_dump search_path resets are also stripped because the runner
-- applies all source files in one session.
-- ==============================================================
...
-- --------------------------------------------------------------
-- source: init/01-extensions/extensions.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/02-schema/001_tables.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/02-schema/002_modifiers.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/02-schema/003_class_ability_modifiers.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/05-seed/001_game_data.sql
-- --------------------------------------------------------------
--
...
-- --------------------------------------------------------------
-- source: init/05-seed/002_class_ability_modifiers.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/05-seed/003_extra_modifiers.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/05-seed/004_fix_hallucinated_abilities_migration.sql
-- --------------------------------------------------------------
...
('en', 'abilities.occult_herbmaster.ezumiel', 'Ezumiel’s Vapor: Pass a dr14 test or severe hallucinations for d4 hours.'),
...
('en', 'abilities.occult_herbmaster.philtre', 'Fernor’s Philtre: Dabbed into eye. Heals infection and gives +2 on Presence tests for d4 hours.'),
('en', 'abilities.occult_herbmaster.hyphos', 'Hyphos’ Enervating Snuff: Berserk! Two attacks per round but defend with dr14. Lasts one fight. Causes sneezing.'),
...
('pl', 'abilities.occult_herbmaster.decoctions', 'Laboratorium Przenośne: Codziennie twórz dwa losowe wywary, łącznie d4 dawek. Tracą moc po 24h.'),
('pl', 'abilities.occult_herbmaster.red_poison', 'Czerwona Trucizna: Wytrzymałość PT12 lub -d10 PŻ.'),
('pl', 'abilities.occult_herbmaster.ezumiel', 'Opary Ezumiela: Test PT14 lub silne halucynacje przez d4 godziny.'),
('pl', 'abilities.occult_herbmaster.frog', 'Gulasz z Żaby Południowej: Wymioty przez d4 godziny, test PT14 aby móc robić cokolwiek innego.'),
('pl', 'abilities.occult_herbmaster.vitalis', 'Eliksir Vitalis: Leczy d6 PŻ i zatrzymuje infekcję. Uzależnia.'),
('pl', 'abilities.occult_herbmaster.soup', 'Zupa z Pająko-Sowy: Widzenie w ciemności i chodzenie po ścianach przez 30 minut.'),
('pl', 'abilities.occult_herbmaster.philtre', 'Filtr Fernora: Wpuszczony do oka leczy infekcję i daje +2 do Obecności przez d4h.'),
('pl', 'abilities.occult_herbmaster.hyphos', 'Tabaka Hyphosa: Szał! Dwa ataki na rundę, ale obrona z PT14. Jedna walka.'),
('pl', 'abilities.occult_herbmaster.black_poison', 'Czarna Trucizna: Wytrzymałość PT14 lub -d6 PŻ i ślepota na godzinę.')
...
-- --------------------------------------------------------------
-- source: init/05-seed/005_add_user_is_anonymous.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/05-seed/006_align_equipment_catalog.sql
-- --------------------------------------------------------------
...
-- --------------------------------------------------------------
-- source: init/05-seed/007_consumable_default_amounts.sql
-- --------------------------------------------------------------
