-- Migration: Fix get_character_full to preserve 'uses' field on equipment/storage
-- The function was dropping the 'uses' array when reconstructing equipment items
